  ...
  <div class="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-950 dark:to-gray-900">
    ...
    <section class="container mx-auto px-6 py-16 md:py-24">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div>
          <h1 class="text-4xl md:text-6xl font-bold mb-6"> Everyone needs a buddy. </h1>
          <p class="text-xl text-gray-600 dark:text-gray-400 mb-8"> Design and chat with personalized AI buddies. Bring
          ...
          <div class="flex flex-col sm:flex-row gap-4">
            ...
            <Button size="lg" variant="outline" asChild>
              <a href="https://docs.buddygenai.com">Docs</a>
            </Button>
          </div>
        </div>
        <div class="relative">
              ...
              <CarouselItem v-for="(pic, index) in pics" :key="index">
                <div class="p-1">
                  <div class="relative aspect-square rounded-xl overflow-hidden">
                    <img :src="pic" :alt="`Screenshot ${index + 1}`" class="object-cover w-full h-full" />
                    <!-- <img
											:src="pic"
    ...
    <section id="features" class="container mx-auto px-6 py-16">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <Card>
          ...
          <CardContent> Create and customize AI buddies with unique personalities, backgrounds, and traits.
          </CardContent>
        </Card>
        <Card>
          <CardHeader>
          ...
          <CardContent> Engage in fluid, context-aware chats powered by advanced language models. </CardContent>
        </Card>
        <Card>
          <CardHeader>
            <CardTitle>Privacy First</CardTitle>
          </CardHeader>
          <CardContent> All data stored locally in your browser using IndexedDB for maximum privacy. </CardContent>
        </Card>
      </div>
    </section>
    <!-- Early Access Notice -->
          ...
          <div class="space-y-4">
            ...
            <Alert>
              ...
              <AlertDescription>
                ...
                <p>I'm continuously working on improvements, but since this is a personal project, updates and support
                  may be slow at times.</p>
              </AlertDescription>
            </Alert>
          </div>
        </CardContent>
  ...
  <Dialog v-model:open="isLightboxOpen">
    <DialogContent class="max-w-3xl">
      <DialogHeader>
        ...
        <DialogDescription>
          <img :src="selectedImage" alt="Large preview" class="w-full h-auto rounded-lg" />
        </DialogDescription>
      </DialogHeader>
    </DialogContent>
  </Dialog>
